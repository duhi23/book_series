...
desarrollada alrededor de los modelos ARCH\index{ARCH!Definici\'{o}n} -- 
...
En la pr\'{a}ctica se supone que $u_{t}\sim N(0,1)$ o que siguen una 
...
Las \index{ARCH!Restricciones}restricciones de signo de los coeficientes de 
...
\begin{definicion}
Un modelo $GARCH(r,s)$, 
est\'{a}\index{GARCH!Definici\'{o}n} definido por:
\begin{align*}
 Z_{t}&=\sqrt h_{t} u_{t} \\ 
...
Las restricciones\index{ARCH!Restricciones} de no negatividad impuestas 
...
un modelo IGARCH. Los modelos IGARCH\index{IGARCH!Definici\'{o}n} son 
...
Con el fin de modelar esta respuesta asim\'{e}trica se han desarrollado una 
...
define\index{EGARCH!Definici\'{o}n} por:
\begin{align*}
 Z_{t}&=\sqrt h_{t} u_{t} \\ 
...
Los modelos\index{TARCH!Definici\'{o}n} TARCH (\textit{Threshold} \textit{ARCH)} fueron introducidos independientemente por Zakoian (1990) y Glosten, Jaganathan y Runklen 
...
Los modelos\index{PARCH!Definici\'{o}n} PARCH (\textit{Power }ARCH) desarrollados 
...
En series de valores sim\'{e}tricos $\gamma_{i}=0$ para
...
Inicialmente se mantiene la estructura para la media condicional, obtenida 
...
En la Tabla 4.1 y en las figuras 4.1 y 4.2 se presentan la informaci\'{o}n 
...
\begin{figure}[H]
\centering
%\includegraphics[width=0.7\textwidth]{Graficos/Cap4STcap41.eps}
\caption{FAC y FACP estimadas residuales del Modelo 3 para la SVM}
\end{figure}

\begin{figure}[H]
\centering
%\includegraphics[width=0.7\textwidth]{Graficos/Cap4STcap42.eps}
...
\begin{figure}[H]
\centering
%\includegraphics[width=0.7\textwidth]{Graficos/Cap4STcap43.eps}
\caption{FAC y FACP estimadas residuales del Modelo 3-ARCH(1) para la SVM}
\end{figure}

\begin{figure}[H]
\centering
%\includegraphics[width=0.7\textwidth]{Graficos/Cap4STcap44.eps}
